...
public class CodeGenerator {
    ...
    //  文件生成地址
    static final String FILE_GENERATION_ADDRESS = PROJECT_PATH_PREFIX + "/client/src/main/java/";
    //  xml存放的路径
    static final String THE_PATH_WHERE_THE_XML_IS_STORED = PROJECT_PATH_PREFIX + "/client/src/main/resources/mapper";
...
//            .Builder("jdbc:mysql://127.0.0.1:32491/cp_xiaota?tinyInt1isBit=false&characterEncoding=utf8&serverTimezone=GMT&tinyInt1isBit=false;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;CASE_INSENSITIVE_IDENTIFIERS=TRUE;MODE=MYSQL",
            .Builder("jdbc:mysql://121.5.155.164:30015/zxxwl?tinyInt1isBit=false&characterEncoding=utf8&serverTimezone=GMT&tinyInt1isBit=false",
            "root",
            "rXSsZ!kVj7D7P78m")
...
//                                .addSuperEntityColumns("id", "created_by", "created_time", "updated_by", "updated_time")
                                        ...
                                        .entityBuilder().superClass("com.zxxwl.web.core.mvc.BaseEntity").enableLombok().enableChainModel()
                                        .serviceBuilder().superServiceClass("com.zxxwl.web.core.db.BaseService").superServiceImplClass("com.zxxwl.web.core.db.BaseServiceImpl")
                                        .mapperBuilder().superClass("com.zxxwl.web.core.db.BaseMapper")
                                        .controllerBuilder().superClass("com.zxxwl.web.core.mvc.BaseController")
                                        .build()
                )
...
//                                .controllerBuilder().formatFileName("%sAction")
                ...
                .templateConfig(cfg ->
                        cfg.disable(TemplateType.ENTITY)
                                .entity("/templates/custom/entity.java")
                                .service("/templates/custom/service.java")
                                .serviceImpl("/templates/custom/serviceImpl.java")
                                .mapper("/templates/custom/mapper.java")
                                .xml("/templates/custom/mapper.xml")
