...
public class CodeBaseGenerator {
    ...
    static final String PROJECT_PACKAGE_PREFIX = "com.zxxwl.login.api";
    static final String PROJECT_DATETIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
    //  文件生成地址
    static final String FILE_GENERATION_ADDRESS = PROJECT_PATH_PREFIX + "/login/src/main/java/";
    //  xml存放的路径
    static final String THE_PATH_WHERE_THE_XML_IS_STORED = PROJECT_PATH_PREFIX + "/login/src/main/resources/mapper";
